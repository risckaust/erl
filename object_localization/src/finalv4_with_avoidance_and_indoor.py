...
class Controller:
	...
	###################################################################################################################
		...
		self.person = roslaunch.parent.ROSLaunchParent(self.uuid, ["/home/nvidia/catkin_ws/src/yolo_ros_vino/launch/person_yolo_ros_vino.launch"])
		self.tags = roslaunch.parent.ROSLaunchParent(self.uuid, ["/home/nvidia/catkin_ws/src/yolo_ros_vino/launch/tags_yolo_ros_vino.launch"])
...
def main():
	...
	rospy.Subscriber("/down/color/image_raw", Image, K.WorkerImageCb)
	# Subscriber: Color Tag Images:
	rospy.Subscriber("/front/color/image_raw", Image, K.TagImageCb)
