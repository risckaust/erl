...
class Controller:
	...
	###################################################################################################################
		...
		self.waypoint1_lat = 22.297117
		self.waypoint1_lon = 39.093789 # Location of Testing Field at KAUST - a little ways down field
		self.waypoint1_alt = 4

		self.waypoint2_lat = 22.2968586
		self.waypoint2_lon = 39.0938304 #39.097909 # Location of Testing Field at KAUST - a little ways down field
		self.waypoint2_alt = 4

		self.waypoint3_lat = 22.29692216 #22.3070405#22.317490
		self.waypoint3_lon = 39.0939668 #39.1047228#39.097909 # Location of Testing Field at KAUST - a little ways down field
		self.waypoint3_alt = 4

		self.waypoint4_lat = 22.2971277
		self.waypoint4_lon = 39.093926
		self.waypoint4_alt = 4

		self.worker1_search_WP1_lat = 22.2974613 # Simulation value
		self.worker1_search_WP1_lon = 39.0935729 # Simulation value
		self.worker1_search_WP2_lat = 22.2975013 # Simulation value
		self.worker1_search_WP2_lon = 39.0935496 # Simulation value
		self.worker1_search_WP3_lat = 22.2975403 # Simulation value
		self.worker1_search_WP3_lon = 39.0936088 # Simulation value
		self.worker1_search_WP4_lat = 22.2974781 # Simulation value
		self.worker1_search_WP4_lon = 39.0936451 # Simulation value
		self.worker1_search_WP5_lat = 22.2975088 # Simulation value
		self.worker1_search_WP5_lon = 39.0937055 # Simulation value
		self.worker1_search_WP6_lat = 22.2975678 # Simulation value
		self.worker1_search_WP6_lon = 39.0936829 # Simulation value
		self.worker1_search_WP7_lat = 22.2975908 # Simulation value
		self.worker1_search_WP7_lon = 39.0937777 # Simulation value
		self.worker1_search_WP8_lat = 22.2975618 # Simulation value
		self.worker1_search_WP8_lon = 39.038198 # Simulation value
		...
		self.building_entr1_lat = 22.2972143 #22.3185652#47.3976886 # Simulation value
		self.building_entr1_lon = 39.0937643 #39.1020314#8.5455664 # Simulation value
		...
		self.building_entr1_inside_lat = 22.2973495
		self.building_entr1_inside_lon = 39.0938034
		self.building_entr2_inside_lat = 22.2973076
		self.building_entr2_inside_lon = 39.0938180
		self.building_entr3_inside_lat = 22.2973076
		self.building_entr3_inside_lon = 39.0938180
	...
	###################################################################################################################
		...
		self.y_FenceLimit_max = 360 # 15 meters to the left of the starting position
		self.y_FenceLimit_min = -360 # 15 meters to the right of the starting position
	...
	def WorkerPoseCb(self, msg):
		...
		if msg is not None and (self.WORKER1SEARCH or self.WORKER2SEARCH or self.WAYPOINT1 or self.WAYPOINT2 or self.WAYPOINT3 or self.WAYPOINT4):
			...
			if (self.WORKER1SEARCH or self.WAYPOINT1 or self.WAYPOINT2 or self.WAYPOINT3 or self.WAYPOINT4):
	...
	def verifyTag(self):
		...
		if self.verifyTAG_flag:
			if self.tag_color == 'Red':
				...
				if (abs(temp_x - self.building_entr1_x) <= 2 and abs(temp_y - self.building_entr1_y) <= 2):
					self.unblocked_entrance = 1
	...
	while not rospy.is_shutdown():
		...
		# !!!!!!!!!!!!!!!!!!!!! MAY ALSO WANT TO CHANGE MAX_XY_VEL HERE TOO FROM 1.5 TO 1.0 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
			...
			if K.enter_bldg_flag == 0:
				...
				reached_unblocked_entrance = K.Execute_Waypoint(K.unblocked_entrance_x,K.unblocked_entrance_y, K.enter_bldg_hgt, target_yaw)
			...
			if (K.mappingdirection ==1 ):
				...
				if (K.current_r == 6):
					...
					K.mappingdirection =2
					K.current_r=6
			elif (K.mappingdirection ==2 ):
				K.mappingdirection =3
